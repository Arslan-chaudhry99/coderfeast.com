        ...
        <>
            ...
            <div className='our_service_bacground_image '>
                <div className="container home_service_padding">
                    <div className='container'>
                        ...
                        <p>We offer Web and App Development services,Cloud Services, Staff Augmentation, UI/UX Design, and Digital Marketing services to help your business generate leads and make sales.</p>
                    </div>
                                            ...
                                            <div class="frontside">
                                                <div class="card home_card_padding shadow border-0 ">
                                                    <div class="card-body text-center align_mentsof_cards">
                                                        ...
                                                        <p class="card-text">
                                                            Make your mark on the world wide web</p>
                                                        <p>Read More
                                            ...
                                            <div class="frontside">
                                                <div class="card home_card_padding shadow border-0 ">
                                                    <div class="card-body text-center align_mentsof_cards">
                                                        ...
                                                        <p class="card-text">
                                                            Elevate your brand with our expert mobile development services</p>
                                                        <p>Read More
                                                            <i class="bi bi-arrow-right"></i>
                                                        </p>
                                                    </div>
                                            ...
                                            <div class="frontside">
                                                <div class="card home_card_padding shadow border-0 ">
                                                    <div class="card-body text-center align_mentsof_cards">
                                                        ...
                                                        <p class="card-text">
                                                            Experience design excellence</p>
                                                        <p>Read More
                                                            <i class="bi bi-arrow-right"></i>
                                                        </p>
                                                    </div>
                                            ...
                                            <div class="frontside">
                                                <div class="card home_card_padding shadow border-0 ">
                                                    <div class="card-body text-center align_mentsof_cards">
                                                        ...
                                                        <p class="card-text">
                                                            Streamline your sales process</p>
                                                        <p>Read More
                                                            <i class="bi bi-arrow-right"></i>
                                                        </p>
                                                    </div>
                                            ...
                                            <div class="frontside">
                                                <div class="card home_card_padding shadow border-0 ">
                                                    <div class="card-body text-center align_mentsof_cards">
                                                        ...
                                                        <p class="card-text">
                                                            Empower your brand with words that matter</p>
                                                        <p>Read More
                                                            <i class="bi bi-arrow-right"></i>
                                                        </p>
                                                    </div>
            ...
            <div className='container talk_to_expert text-white '>
                <div className='home_gettouch_section'>
                    <h2 className='col-12 '>
                        <strong>Integrate your business using our  cutting-edge  software solutions.</strong>
                    </h2>
                </div>
