                ...
                < div class="" >
                    <form onSubmit={handleSubmit} >
                        <div className='d-inline  position-relative'>
                            <input type="text" name='name' id='name' value={values.name} onChange={handleChange} onBlur={handleBlur} className="aboutus_input_filed aboutus_input_filed_input bg-white text-dark rounded global_input_border" placeholder="First Name*" style={errors.name && touched.name ? { backgroundColor: "red" } : null} />
                            <small className='position-absolute text-danger' style={{ top: "0", left: "0", marginTop: "-40px" }}>
                                {errors.name && touched.name ? errors.name : null}
                            </small>
                        </div>
                        <input type="text" class="aboutus_input_filed aboutus_input_filed_input bg-white text-dark rounded global_input_border" placeholder="Last Name(opt)" style={{ color: "white" }} />
                        <div className='d-inline  position-relative'>
                            <input type="text" name='phone' id='phone' value={values.phone} onChange={handleChange} onBlur={handleBlur} className="aboutus_input_filed aboutus_input_filed_input bg-white text-dark rounded global_input_border" placeholder="Phone*" />
                            <small className='position-absolute text-danger' style={{ top: "0", left: "0", marginTop: "-40px" }}>
                        ...
                        <div className='d-inline  position-relative'>
                            <input type="text" name='email' id='email' value={values.email} onChange={handleChange} onBlur={handleBlur} className="aboutus_input_filed aboutus_input_filed_input bg-white text-dark rounded global_input_border" placeholder="Email*" />
                            <small className='position-absolute text-danger' style={{ top: "0", left: "0", marginTop: "-40px" }}>
                        ...
                        <div className='d-flex flex-column'>
                            ...
                            <textarea name='message' id='message' value={values.message} onChange={handleChange} onBlur={handleBlur} className="aboutus_input_filed aboutus_input_filed_textarea bg-white text-dark rounded global_input_border" placeholder="Message...."></textarea>
                        </div>
                        <br />
                        <button className="get_in_touch_btn px-2 py-1 shadow" type='submit'>Submit</button>
                    </form>
                </div>
            </section>
